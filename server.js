...
let config = require('./API/config'); //we load the db location from the JSON files
let meetup = require('./API/app/routes/meetup');
let question = require('./API/app/routes/question');
